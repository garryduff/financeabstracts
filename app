...
if (button==True):
 response = openai.Completion.create(
  model="babbage:ft-personal-2023-02-14-11-21-48",
  prompt=abstract,
  temperature=0,
  max_tokens=3,
  top_p=1,
 ...
 st.write("This abstracts scores " + predstarall2dp + " out of a maximum of 5.0. Other abstracts of this score have had a " + predprob5pct2dp + "% success rate of being published in a world elite (4+ star) journal, and " + predprob4pct2dp + "% of being published in a leading (4 star) journal.") 
 st.write("The most likely venues for publication are: " + prednames1 + ", " + prednames2 + ", " + prednames3 + ".")
